...
%
\setstocksize{20.5cm}{13.5cm}
\settrimmedsize{\stockheight}{\stockwidth}{*}
\settypeblocksize{6.46in}{4.22in}{*}
\setlrmargins{*}{*}{0.8}
\setulmargins{*}{*}{0.8}
...
\newfontface\hp[ExternalLocation=fonts/, LetterSpace=18.0, WordSpace=2.5]{Lumos}
\newcommand{\lumos}[1]{{\hp\MakeUppercase{#1}}}
% Chapter numbers: Lumos (extreme spacing for effect)
\newfontface\hpchap[ExternalLocation=fonts/, LetterSpace=80.0, WordSpace=7.0]{Lumos}
%
...
\makechapterstyle{evans}{%
	...
	\renewcommand*{\chaptermark}[1]{% "CHAPTER ONE" and "A DAY OF..."
		\markboth{\scriptsize\MakeUppercase{##1}}{%
		  \scriptsize\MakeUppercase{\chaptername}~\thechapter}}
...
\newcommand*{\wrapchapter}[2]{\chapter[#1 #2]{#1\protect\linebreak #2}}
...
%
\linespread{1.15} % Wider line spacing looks much better
...
%
\newcommand{\pageInFooter}{{\footnotesize\makebox[2em][c]{\thepage}}}
...
\makeevenhead{headings}{}{
	\hp\hyperref[contents]{\small\rightmark}}{}
\makeatletter
\makeoddhead{headings}{}{\parbox{99mm}{\centering\hp\small\leftmark}}{}
