...
\newfontface\hp[ExternalLocation=fonts/, LetterSpace=15.0, WordSpace=2.5]{Lumos}
...
\newcommand{\formatPart}[1]{\ifnum0<0#1\relax Part~\RomNum{#1}\else \ifnum0=#1\relax Part~0\else #1\fi\fi}
