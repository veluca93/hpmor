...
\newfontface\hp[ExternalLocation=fonts/, LetterSpace=6.0, WordSpace=1.85]{Lumos}
\newcommand{\lumos}[1]{{\hp\MakeUppercase{#1}}}
% Chapter numbers: Lumos (extreme spacing for effect)
\newfontface\hpchap[ExternalLocation=fonts/, LetterSpace=40.0, WordSpace=5.0]{Lumos}
%
